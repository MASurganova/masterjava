...
public class UserProcessor {
    ...
    public List<FailedEmails> process(final StaxStreamProcessor processor, Map<String, City> cities, Map<String, Group> groupMap, int chunkSize) throws XMLStreamException, JAXBException {
        ...
        List<UserGroup> chunkUserGroups = new ArrayList<>();
        ...
        if (!chunk.isEmpty()) addChunkFutures(chunkFutures, chunk, chunkUserGroups);
    ...
    private void addChunkFutures(Map<String, Future<List<String>>> chunkFutures, List<User> chunk, List<UserGroup> chunkUserGroup) {
        ...
        Future<List<String>> future = executorService.submit(() -> {
            val conflictEmails =  userDao.insertAndGetConflictEmails(chunk);
            userGroupDao.insertBatch(chunkUserGroup);
